        ...
        <div onMouseMove={(e) => handleMouseMove(e)} className='relative bg-black'>
            ...
            <div className='w-full h-screen p-[2vw] py-0 flex flex-col sm:flex-row items-start pb-[2vw] pt-[20vw] sm:pt-[7vw]'>
                ...
                <div className='w-full sm:w-[68%] text-white h-[40vh] sm:h-full flex flex-col justify-between '>
                    <h1 className='text-[15vw] sm:text-[10vw] capitalize leading-none font-[font5]'>axel vanhessche</h1>
                    <div className='w-full flex'>
                        <div className='hidden sm:block w-[23%] h-[40vh] overflow-hidden'>
                        ...
                        <div className='w-full sm:w-[50%] ml-[2vw] pb-[5vw] sm:pb-[0] flex flex-col justify-end'>
                         <h4 className='font-[font4] text-[5vw] sm:text-[1vw] text-white/80 mb-[.2vw]'>Services Provided</h4>
                         <h2  className='font-[font4] text-[3vw] sm:text-[.8vw] text-white/50'>Brand Strategy, Website Design, Social Media Campaigns</h2>
                         <h4 className='font-[font4] text-[5vw] sm:text-[1vw] text-white/80 mb-[.2vw] mt-[1vw]'>Team Members</h4>
                         <h2  className='font-[font4] text-[3vw] sm:text-[.8vw] text-white/50'>Sarah Thompson, John Miller, Emma Davis</h2>
                        </div>
                    </div>
                </div>
                <div className='w-full sm:w-[32%]  h-[60vh] sm:h-full flex items-end overflow-hidden'>
            ...
            <div className='w-full  h-[100vh] sm:h-[120vh] flex items-center pl-[10%] pr-[2%] sm:pr-[0] sm:pl-[30%]'>
                <div className='w-full sm:w-[25vw] h-[60vh] sm:h-[85vh] overflow-hidden data-scroll'>
            ...
            <div className='w-full min-h-screen flex flex-col sm:flex-row'>
                <div className='w-full sm:w-1/2 h-full pl-[2vw] pr-[2vw] sm:pr-[0]'>
                    <div className='w-full h-[80vh]'>
                        <div className='w-full sm:w-[70%] h-full overflow-hidden data-scroll'>
                    ...
                    <div className='w-full h-[50vh] mt-[30vh] sm:mt-[40vh] pl-[20%]'>
                        <div className='w-full sm:w-[50%] h-full overflow-hidden data-scroll'>
                ...
                <div className='w-full sm:w-1/2 h-full p-[2vw]'>
                    <div className='w-full h-[38vh] flex justify-start sm:justify-end'>
                        <div className='w-[80%] sm:w-[33%] h-full overflow-hidden data-scroll'>
                    ...
                    <div className='w-full h-[70vh] mt-[20vh] flex justify-start'>
                        <div className='w-full sm:w-[55%] h-full overflow-hidden data-scroll'>
            ...
            <div className='w-full h-screen p-[2vw] flex flex-col sm:flex-row items-start'>
                <div className='w-full sm:w-[68%] text-white h-full flex flex-col justify-end'>
                    <div className='w-full flex justify-end sm:justify-start'>
                        <div className='w-[70%] sm:w-[35%] h-[40vh] overflow-hidden data-scroll'>
                ...
                <div className='w-full sm:w-[32%]  h-full flex'>
                    <div className='w-full h-[60vh] sm:h-[85vh] overflow-hidden data-scroll'>
            ...
            <div className='w-full py-[3vw] pb-[10vw]'>
                <div className='w-full text-white capitalize mb-[3vw] px-[2vw] flex gap-[4vw]'>
                    <h1 className='text-[10vw] sm:text-[5vw] font-[font6]'>Latest project</h1>
                </div>
                <div onMouseMove={handleMouseMove2} onMouseLeave={handleMouseLeave} className='mar-p w-full flex gap-[1.5vw]'>
                    <div className='marquee2 w-fit flex items-center text-white/50 font-[font4] text-[4vw] gap-[1.5vw] uppercase'>
                        <Link href="/work/kuchenbuddy" className='w-[40vw] sm:w-[20vw] h-[25vw] sm:h-[12vw] cursor-pointer'>
