    ...
    return (
        <div className='w-full min-h-screen px-[2vw] pt-[8vw]'>
            ...
            <div className='clipimg w-full px-[2vw] sm:px-0 flex flex-col md:flex-row gap-[2vw]'>
                <div className='w-full md:w-1/2 h-[50vh] sm:h-[80vh] md:h-[80vh] lg:h-[120vh]'>
                ...
                <div className='w-full md:w-1/2 h-[60vh] sm:h-[100vh] md:h-[80vh] lg:h-[100vh] xl:h-[120vh]'>
            ...
            <div className='w-full py-[10vw] px-[2vw] sm:px-0 sm:py-[5vw] pb-[10vw] text-white font-[heading2] tracking-wide  text-[4vw] sm:text-[2vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1.2vw]  flex flex-col items-center gap-[10vw] sm:gap-[4vw]'>
                <h4 className='sect2-txt w-full md:w-[60%] lg:w-[40%]'>
