...
const Section2 = () => {
    ...
    return (
        <div className='w-full min-h-screen px-[2vw]'>
            <div className='select-work relative w-full py-[1.2vw] flex'>
                <div className='overflow-hidden'>
                    <h2 className='work-txt-about text-white text-[5vw] font-[font6] leading-none' style={{ transform: "translateY(100%)" }}>About Us</h2>
                </div>
                <div className="line-about w-[0] h-[1px] bg-white/60 absolute left-0 bottom-0"></div>
            </div>
            <h2 className='sec2-txt1 text-white font-[font6] w-[70%] text-[2vw] capitalize my-[5vw]'>Welcome to LuxeFrame, where we transform moments into timeless visual narratives. Founded with a
            ...
            <div className='clipimg w-full flex gap-[2vw]'>
                <div className='w-1/2 h-[120vh]'>
                    <img style={{ clipPath: "polygon(0 100%, 100% 100%, 100% 100%, 0 100%)" }} className='img-clip w-full h-[50%] object-cover' src="https://luxeframe.netlify.app/about1.webp" alt="" />'
                </div>
                <div className='w-1/2 h-[120vh]'>
            ...
            <div className='w-full py-[5vw] pb-[10vw] text-white font-[font4] text-[1.1vw] flex flex-col items-center gap-[4vw]'>
                <h4 className='sect2-txt w-[50%]'>
