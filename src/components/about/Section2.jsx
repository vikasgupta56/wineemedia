        ...
        <div className='w-full min-h-screen px-[2vw]'>
            ...
            <div className='clipimg w-full flex flex-col md:flex-row gap-[2vw]'>
                <div className='w-full md:w-1/2 h-[80vh] md:h-[120vh]'>
                    <img style={{ clipPath: "polygon(0 100%, 100% 100%, 100% 100%, 0 100%)" }} className='img-clip w-full h-[70%] md:h-[50%] object-cover' src="/aboutimg1.avif" alt="about-us-banner1" />'
                </div>
                <div className='w-full md:w-1/2 h-[80vh] md:h-[120vh]'>
                    <img style={{ clipPath: "polygon(0 100%, 100% 100%, 100% 100%, 0 100%)" }} className='img-clip w-full h-full object-cover' src="/aboutimg2.avif" alt="about-us-banner2" />
                </div>
            </div>
