...
const Section2 = () => {
    ...
    return (
        <div className='w-full min-h-screen px-[2vw]'>
            ...
            <h2 className='sec2-txt1 text-white font-[font6] w-full md:w-[70%] text-[4vw] md:text-[2vw] capitalize my-[10vw] md:my-[5vw]'>WineeMedia is a branding and marketing agency specializing in providing comprehensive online solutions for businesses aiming to enhance their digital presence. They offer a wide range of services including social media management, content creation, SEO optimization, and targeted advertising campaigns.
            </h2>
            ...
            <div className='w-full py-[10vw] sm:py-[5vw] pb-[10vw] text-white font-[font4] text-[4vw] md:text-[1vw] lg:text-[1.2vw]  flex flex-col items-center gap-[10vw] sm:gap-[4vw]'>
