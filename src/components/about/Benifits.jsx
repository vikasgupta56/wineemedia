...
const Benifits = () => {
  ...
  return (
    ...
    <h2 className='benfit-txt1 text-white font-[font6] w-full md:w-[70%] text-[4vw] md:text-[2vw] capitalize my-[10vw]  sm:my-[5vw]'>
    ...
    <div className='w-full flex flex-col md:flex-row gap-[10vw] sm:gap-[2vw]'>
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font6] text-[4vw] sm:text-[3vw] md:text-[1.4vw] lg:text-[1.4vw] my-[5vw] md:my-[1.5vw]'>Exceptional Quality and Creativity</h3>
            <p className='text-[4vw] sm:text-[2vw] md:text-[1vw] lg:text-[1.2vw] w-[95%] text-white/60 font-[font1]'>
        ...
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font6] text-[4vw] sm:text-[3vw] md:text-[1.4vw] lg:text-[1.4vw] my-[5vw] md:my-[1.5vw]'>Professional and Personalized Service</h3>
            <p className='text-[4vw] sm:text-[2vw] md:text-[1vw] lg:text-[1.2vw] w-[95%] text-white/60 font-[font1]'>
        ...
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font6] text-[4vw] sm:text-[3vw] md:text-[1.4vw] lg:text-[1.4vw] my-[5vw] md:my-[1.5vw]'>Versatile and Comprehensive Solutions</h3>
            <p className='text-[4vw] sm:text-[2vw] md:text-[1vw] lg:text-[1.2vw] w-[95%] text-white/60 font-[font1]'>
    ...
    <div className='marquee-about w-fit  flex items-center text-white font-[styles] text-[6vw] gap-[3vw]'>
        <span>-</span>
    ...
    <div className='marquee-about w-fit flex items-center text-white font-[font6] text-[6vw] gap-[3vw]'>
        <span>-</span>
        <h5 className='whitespace-nowrap'>WineeMedia</h5>
        <span>-</span>
        <h5 className='whitespace-nowrap'>WineeMedia</h5>
