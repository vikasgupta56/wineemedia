...
const Benifits = () => {
  ...
  return (
    ...
    <div className='select-work2 relative w-full py-[1.2vw] flex'>
        <div className='overflow-hidden'>
            <h2 className='work-txt-about2 text-white text-[5vw] font-[font6] leading-none' style={{ transform: "translateY(100%)" }}>Benefits</h2>
        </div>
    ...
    <div className='w-full flex gap-[2vw]'>
        <div className='w-full relative'>
            ...
            <h3 className='text-white font-[font4] text-[1.4vw] my-[1.5vw]'>Exceptional Quality and Creativity</h3>
            <p className='text-[1vw] text-white/60 font-[font1]'>
        ...
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font4] text-[1.4vw] my-[1.5vw]'>Professional and Personalized Service</h3>
            <p className='text-[1vw] text-white/60 font-[font1]'>
        ...
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font4] text-[1.4vw] my-[1.5vw]'>Versatile and Comprehensive Solutions</h3>
            <p className='text-[1vw] text-white/60 font-[font1]'>
