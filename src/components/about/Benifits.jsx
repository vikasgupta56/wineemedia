...
const Benifits = () => {
  ...
  return (
    ...
    <div className='select-work2 relative w-full py-[5vw] sm:py-[1.2vw] flex'>
        <div className='overflow-hidden'>
            <h2 className='work-txt-about2 text-white text-[10vw] sm:text-[5vw] font-[font6] leading-none' style={{ transform: "translateY(100%)" }}>Benefits</h2>
        </div>
        <div className="line-about2 w-[0] h-[1px] bg-white/60 absolute left-0 bottom-0"></div>
    </div>
    <h2 className='benfit-txt1 text-white font-[font6] w-full sm:w-[70%] text-[3vw] sm:text-[2vw] capitalize my-[5vw]'>
    ...
    <div className='w-full flex flex-col sm:flex-row gap-[2vw]'>
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font4] tex-[4vw] sm:text-[1.4vw] my-[5vw] sm:my-[1.5vw]'>Exceptional Quality and Creativity</h3>
            <p className='text-[3vw] sm:text-[1vw] text-white/60 font-[font1]'>
        ...
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font4] tex-[4vw] sm:text-[1.4vw] my-[5vw] sm:my-[1.5vw]'>Professional and Personalized Service</h3>
            <p className='text-[3vw] sm:text-[1vw] text-white/60 font-[font1]'>
        ...
        <div className='w-full relative'>
            <div className="lineab w-full h-[1px] bg-white/60 top-0 left-0"></div>
            <h3 className='text-white font-[font4] tex-[4vw] sm:text-[1.4vw] my-[5vw] sm:my-[1.5vw]'>Versatile and Comprehensive Solutions</h3>
            <p className='text-[3vw] sm:text-[1vw] text-white/60 font-[font1]'>
