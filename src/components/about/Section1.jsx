  ...
  return (
    <div className='w-full h-[100svh] text-white flex flex-col items-end justify-end px-[4vw] sm:px-[2vw]'>
        ...
        <div className='btm-container opacity-0  w-full flex items-start justify-between mt-[15vw] sm:mt-[5vw] pt-[3vw] sm:pt-[1vw] pb-[6vw] sm:pb-[.5vw] border-t border-white/20'>
          <div className='w-1/2'>
          <p className='text-[3.5vw] sm:text-[2vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw] para font-[heading2] tracking-wide '>We operate on <br /> simple principles</p></div>
          <div className='w-1/2'>
          <ul >
            <li className='text-[3.5vw] sm:text-[2vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw] para font-[heading2] tracking-wide '>(01)  Put people first</li>
            <li className='text-[3.5vw] sm:text-[2vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw] para font-[heading2] tracking-wide '>(02)  Pursue excellence</li>
            <li className='text-[3.5vw] sm:text-[2vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw] para font-[heading2] tracking-wide '>(03)  Embrace challenges</li>
          </ul>
          </div>
        </div>
    </div>
