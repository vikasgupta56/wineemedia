...
const OurClient = () => {
    ...
    return (
        <div className='w-full py-[8vw] text-white px-[2vw]'>
            <div className='h-[6vw] client-txt-p overflow-hidden'>
                <h2 className='client-txt text-[5vw] font-[font6] leading-none py-[.6vw]' style={{transform:"translateY(100%)"}}>Still not convinced?</h2>
            </div>
            <div className='h-[6vw] client-txt-p overflow-hidden'>
                <h2 className='client-txt text-[5vw] font-[font6] leading-none py-[.6vw]' style={{transform:"translateY(100%)"}}>Well, they were.</h2>
            </div>
            ...
            <h2 className='client-txt1 text-white font-[font6] w-[70%] text-[2vw] capitalize my-[5vw]'>
