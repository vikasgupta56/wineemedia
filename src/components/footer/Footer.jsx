...
const Footer = () => {
    ...
    return (
        <div className='w-full flex flex-col justify-between h-[70vh] relative sm:h-[75vh] md:h-[60vh] lg:h-[75vh] bg-black p-[4vw] sm:p-[2vw] sm:pt-[4vw] pt-[10vw] text-white'>
            <div className='w-full flex flex-col md:flex-row items-start justify-between'>
                <div>
                    <h3 className='text-[10vw] sm:text-[3.5vw] font-[heading2] leading-[.8] whitespace-nowrap'>Let's Connect</h3>
                    <h6 className='font-[heading2] tracking-wide text-[4vw] sm:text-[2.5vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw]  mb-[10vw] sm:mb-0 mt-[3vw] sm:mt-[1.4vw]'>info@wineemedia.com</h6>
                </div>
                <div className='flex gap-[8vw] flex-col md:flex-row font-[heading2] tracking-wide'>
                    <div className='flex flex-col gap-[.3vw] text-[4vw] sm:text-[2.5vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw]'>
            ...
            <div className='w-full text-white font-[heading2]'>
                ...
                <div className='w-full flex text-[3.6vw] tracking-wide flex-col sm:flex-row  sm:text-[2vw] md:text-[1.8vw]  lg:text-[1.3vw] xl:text-[1vw] text-white/50 font-[heading2] items-left sm:items-center justify-between'>
                    <h6 className='mb-[.6vw] mt-[2vw] sm:mt-0 sm:mb-0'>© 2024 by WineeMedia.</h6>
                    <h6>Developed By <Link target='_blank' title='zerrorstudios' href="https://www.zerrorstudios.com/" className='zerror-link font-[heading2] text-white/80'>Zerror Studios</Link></h6>
                </div>
            </div>
        </div>
    )
