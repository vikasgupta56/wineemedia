    ...
    return (
        <div className='w-full flex flex-col justify-between h-[70vh] sm:h-screen bg-black p-[4vw] sm:p-[2vw] pt-[10vw] sm:pt-[4vw] text-white'>
            <div className='w-full flex flex-col sm:flex-row items-start justify-between'>
                <div>
                    <h1 className='text-[15vw] sm:text-[6vw] font-[font6] leading-[.8]'>Let's Connect</h1>
                    <h2 className='font-[font6] text-[4vw] sm:text-[1vw]  mb-[10vw] sm:mb-0 mt-[3vw] sm:mt-[1.4vw]'>info@wineemedia.com</h2>
                </div>
                <div className='flex gap-[8vw] flex-col sm:flex-row'>
            ...
            <div className='w-full text-white font-[font6]'>
                <div className='overflow-hidden flex items-center justify-center'>
                    <h1 ref={titleRef} className='hidden sm:block logo-title text-[15.5vw] whitespace-nowrap leading-none' >{"wineemedia".split("").map((l, i) => <span key={i} style={{transform:"translateY(-100%)"}} className='inline-block'>{l}</span>)}</h1>
