        ...
        <div className='w-full flex flex-col justify-between h-[70vh] relative sm:h-[75vh] md:h-[60vh] lg:h-[75vh] bg-black p-[4vw] sm:p-[2vw] sm:pt-[4vw] pt-[10vw] text-white'>
            <div className='w-full flex flex-col md:flex-row items-start justify-between'>
                <div>
                    ...
                    <h6 className='font-[heading2] text-[4vw] sm:text-[2.5vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1vw]  mb-[10vw] sm:mb-0 mt-[3vw] sm:mt-[1.4vw]'>info@wineemedia.com</h6>
                </div>
            ...
            <div className='w-full text-white font-[heading2]'>
                ...
                <div className='w-full flex text-[4vw] flex-col sm:flex-row  sm:text-[2vw] md:text-[1.8vw]  lg:text-[1.3vw] xl:text-[1vw] text-white/50 font-[font4] items-left sm:items-center justify-between'>
