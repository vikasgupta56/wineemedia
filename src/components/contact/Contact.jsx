  ...
  return (
    <>
      <div onClick={() => {
                    ...
                    <div id='contact-page' ref={contactRef} className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[99] w-full sm:w-[70%] md:w-[50%] h-full sm:h-fit overflow-hidden bg-black/50 sm:rounded-2xl flex flex-col' style={{ backdropFilter: "blur(50px)" }}>
                        <div className='w-full bg-[#222222] px-[3vw] sm:px-[1vw] py-[4vw] sm:py-[1.7vw] md:py-[.8vw] flex items-center justify-between'>
                            <div className='flex gap-[4vw] sm:gap-[.4vw]'>
                                <div className='w-[4vw] sm:w-[1.5vw]  md:w-[.9vw] h-[4vw] sm:h-[1.5vw] md:h-[.9vw] bg-red-600 rounded-full'></div>
                                <div className='w-[4vw] sm:w-[1.5vw]  md:w-[.9vw] h-[4vw] sm:h-[1.5vw] md:h-[.9vw] bg-[#F3BF49] rounded-full'></div>
                                <div className='w-[4vw] sm:w-[1.5vw]  md:w-[.9vw] h-[4vw] sm:h-[1.5vw] md:h-[.9vw] bg-[#58595B] rounded-full'></div>
                            </div>
                            <button onClick={() => {
                                setErrors({})
                                setisOpen(false)
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='w-full p-[1.5vw] font-[font3] pt-[10vw] sm:pt-[2vw] md:pt-[1.5vw]'>
                                ...
                                <textarea
                                    className={`w-full outline-none bg-transparent text-white text-[3.5vw] sm:text-[1.7vw] md:text-[1vw] flex items-center border-b border-white/40 py-[1vw] h-[35vh] resize-none`}
                                ...
                                <div className='w-full flex items-center justify-between mt-[20vh] sm:mt-[2vw] md:mt-0'>
                                    ...
                                    <button type="submit" className='w-full sm:w-fit py-[3vw] sm:py-[.8vw] text-white bg-gray-500/30 mt-[5vw] sm:mt-[1.5vw] rounded-md text-[4vw] sm:text-[2vw] md:text-[1vw] px-[8vw] sm:px-[2.3vw]'>Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
