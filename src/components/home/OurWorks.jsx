    ...
    const servicesData = [
        {
            ...
            description: "Building visuals that define your brand.",
        ...
        },
        {
            ...
            description: "Driving engagement to grow your brand.",
        ...
        {
            title: "3D Designing",
            description: "Creating immersive, lifelike 3D experiences.",
        ...
        <div className='our-work w-full py-[2vw] pb-[10vw] sm:pb-[6vw] bg-black'>
            <div className='select-work2 relative w-full mx-[2vw] py-[5vw] sm:py-[1.2vw] flex mt-[6vw]'>
                <div className='overflow-hidden'>
                    <h2 className='work-txt2 text-black text-[10vw] sm:text-[5vw] font-[font6] leading-none' style={{ transform: "translateY(100%)" }}>uncover what we can serve</h2>
                </div>
            ...
            {servicesData.map((service, index) => (
                ...
                >
                    ...
                    <h5 className='hidden sm:block w-[10%] text-right text-[1.1vw]'>{service.description}</h5>
