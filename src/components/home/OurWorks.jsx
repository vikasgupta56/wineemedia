        ...
        <div className='our-works w-full py-[2vw] pb-[10vw] sm:pb-[6vw] bg-black'>
            <div className='select-work2 relative w-full mx-[2vw] py-[5vw] sm:py-[1.2vw] flex mt-[6vw]'>
                <div className='overflow-hidden'>
                    <h3 className='work-txt2 text-black text-[10vw] w-[90%] sm:w-full sm:text-[4.3vw] font-[heading2] leading-none capitalize' style={{ transform: "translateY(100%)" }}>uncover what we can serve</h3>
                </div>
            ...
            <div className=''>
                {servicesData.map((service, index) => (
                    <div
                        ...
                        className='our-work relative px-[4vw]  sm:px-[2vw] flex items-center justify-between text-black py-[6vw] sm:py-[7vw] md:py-[4vw] border-b  border-black/40'
                    >
                        <h4 className='z-10 text-[6.2vw] sm:text-[4.2vw] md:text-[3.2vw] font-[heading2] sm:font-semibold pointer-events-none'>{service.title}</h4>
                        ...
                        <div className='w-full h-full overflow-hidden absolute pointer-events-none top-0 z-[11] left-0'>
                            ...
                            <h4 style={{ color: service.text }} className='text-[6vw] sm:text-[4vw] md:text-[3vw] font-[heading2] sm:font-semibold pointer-events-none'>{service.title}</h4>
