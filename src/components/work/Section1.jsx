  ...
  return (
    <div className='w-full min-h-screen'>
      ...
      <div className="projects w-full flex flex-col md:flex-row justify-start gap-[0.5%] flex-wrap py-[5vw] md:py-[2vw] px-[2vw]">
        ...
        {workData.map((project, i) => (i === 0 ? (<Link href={`/work/${project.projectname}`} key={i} className='project w-full md:w-[49.5%] mb-[2vw] cursor-pointer'>
        ...
        </Link>) : i === 3 ? (<Link href={`/work/${project.projectname}`} key={i} className='project w-full md:w-[100%%] mb-[2vw] cursor-pointer'>
